...
export default function ReprotsBar() {
  ...
  return (
    <div className="fixed select-none bottom-0 w-full mx-auto max-w-screen-sm grid grid-cols-2 border-gray-600 border-t px-5 py-3 bg-neutral-900 *:text-white *:text-sm *:font-light">
      <Link
        href="/reports/kintai"
